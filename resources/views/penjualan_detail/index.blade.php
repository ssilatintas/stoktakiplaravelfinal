    ...
    <div class="col-lg-12">
        <div class="box">
            <div class="box-body">
                ...
                <form class="form-produk">
                    ...
                    <div class="form-group row">
                        <label for="kode_produk" class="col-lg-2">Ürün Kodu</label>
                        <div class="col-lg-5">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <form action="{{ route('transaksi.simpan') }}" class="form-penjualan" method="post">
                            ...
                            <div class="form-group row">
                                <label for="totalrp" class="col-lg-2 control-label">Toplam</label>
                                <div class="col-lg-8">
                                    <input type="text" id="totalrp" class="form-control" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="kode_member" class="col-lg-2 control-label">Üye</label>
                                <div class="col-lg-8">
                                    <div class="input-group">
                            ...
                            <div class="form-group row">
                                <label for="bayar" class="col-lg-2 control-label">Ödeme</label>
                                <div class="col-lg-8">
                                    <input type="text" id="bayarrp" class="form-control" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="diterima" class="col-lg-2 control-label">Alınan</label>
                                <div class="col-lg-8">
                                    <input type="number" id="diterima" class="form-control" name="diterima" value="{{ $penjualan->diterima ?? 0 }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="kembali" class="col-lg-2 control-label">Para Üstü</label>
                                <div class="col-lg-8">
            ...
            <div class="box-footer">
                <button type="submit" class="btn btn-success btn-sm btn-flat pull-right btn-simpan"><i class="fa fa-floppy-o"></i> İşlemi Kaydet</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    $(function () {
        ...
        $(document).on('input', '.quantity', function () {
            ...
            if (jumlah < 1) {
                $(this).val(1);
                alert('Sayı 1\'den küçük olamaz');
                return;
            }
            if (jumlah > 10000) {
                $(this).val(10000);
                alert('Sayı 10000\'den büyük olamaz');
                return;
            }
    ...
    function deleteData(url) {
        if (confirm('Seçili veriyi silmek istediğinizden emin misiniz?')) {
            $.post(url, {
                    '_token': $('[name=csrf-token]').attr('content'),
                    '_method': 'delete'
                })
    ...
    function loadForm(diskon = 0, diterima = 0) {
        ...
        $.get(`{{ url('/transaksi/loadform') }}/${diskon}/${$('.total').text()}/${diterima}`)
            .done(response => {
                ...
                $('.tampil-bayar').text('Ödeme: $ '+ response.bayarrp);
                $('.tampil-terbilang').text(response.terbilang);

                $('#kembali').val('$'+ response.kembalirp);
                if ($('#diterima').val() != 0) {
                    $('.tampil-bayar').text('Para Üstü: $ '+ response.kembalirp);
