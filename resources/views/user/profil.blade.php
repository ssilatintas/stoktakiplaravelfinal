            ...
            <form action="{{ route('user.update_profil') }}" method="post" class="form-profil" data-toggle="validator" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    <div class="alert alert-info alert-dismissible" style="display: none;">
                        ...
                        <i class="icon fa fa-check"></i>Değişiklikler Başarıyla Kaydedildi
                    </div>
                    <div class="form-group row">
                        <label for="name" class="col-lg-2 control-label">İsim</label>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group row">
                        <label for="old_password" class="col-lg-2 control-label">Eski Şifre</label>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group row">
                        <label for="password" class="col-lg-2 control-label">Şifre</label>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group row">
                        <label for="password_confirmation" class="col-lg-2 control-label">Şifreyi Onayla</label>
                        <div class="col-lg-6">
                ...
                <div class="box-footer text-right">
                    <button class="btn btn-sm btn-flat btn-primary"><i class="fa fa-save"></i>Değişiklikleri Kaydet</button>
                </div>
            </form>
        </div>
    </div>
